...
All generators return scipy sparse CSR matrices representing the adjacency matrix.
"""
...
def generate_bipartite_graph(n_top=50, n_bottom=100, p=0.1, seed=0):
    ...
    Parameters:
      ...
      p: float
         Probability of edge between any pair of vertices from different sets.
      seed: int
         Random seed for reproducibility.
...
def generate_complete_bipartite_graph(n_top=50, n_bottom=100):
    ...
    to every vertex in the bottom set.
